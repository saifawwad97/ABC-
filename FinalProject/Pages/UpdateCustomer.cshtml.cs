    ...
    public class UpdateCustomerModel : PageModel
    {
        ...
        public void Onpost()
        {
            ...
            try
            {
                ...
                RequestDirector.UpdateCustomer(customer.CustomerID, customer.CustomerName, customer.Addresses, customer.City, customer.Province, customer.PostalCode);
            ...
            successMessage = "The Customer Was Updated Successfully";
            return;
        }
    }
}
